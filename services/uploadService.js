define([],function() {
  ...
  console.log('upload service: loading');
  ...
  return { 
    ...
    init: function(serviceName) {
      console.log('uploadService service: init() firing');
      ...
      console.log('uploadService service: message sent to uploadService back-end service');
    },
    ...
    onMessage: {
      ...
      getUserData: function(messageObj) {
        console.log('uploadService service: response received from uploadService back-end service');
